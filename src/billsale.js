...
function rBillOfSaleView(){
  ...
  // ---- GENERATE BUTTON ----
  var genBtn=h("button",{class:"bp",style:{width:"100%",marginTop:"8px",padding:"14px"},onclick:function(){_bosGeneratePDF()}},I.dlFile+" Generate PDF");
  root.append(genBtn);

  // ---- RESET ----
  var rstBtn=h("button",{class:"bs",style:{width:"100%",justifyContent:"center"},onclick:function(){_bosReset();R()}},I.trash+" Clear Form");
  root.append(rstBtn);
...
function _bosDLSection(){
  ...
  if(_bos.buyerDL){
    ...
    card.append(img);
    var rmBtn=h("button",{class:"bs",style:{justifyContent:"center"},onclick:function(){_bos.buyerDL=null;R()}},I.trash+" Remove");
    card.append(rmBtn);
  }else{
